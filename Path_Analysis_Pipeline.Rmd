...
---
To use: After setting the working directory as the folder containing the "raw data" folder, simply run all. This will populate the "processed data" folder with the results.
