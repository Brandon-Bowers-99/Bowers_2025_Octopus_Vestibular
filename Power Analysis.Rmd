...
PA_MT.lme=lme((Movement_Type)~Trial_Type*NewDates,random=~1|OC_ID,
                       data=PA_master_set)
...
obs_diff =  mean(PA_master_set$Movement_Type[PA_master_set$Trial_Type == "4"]) -
            mean(PA_master_set$Movement_Type[PA_master_set$Trial_Type == "1"])
...
temporary$Movement_Type[PA_master_set$Trial_Type == "4"]=
  temporary$Movement_Type[PA_master_set$Trial_Type == "4"]+step

mean_diff=mean(temporary$Movement_Type[temporary$Trial_Type == "4"]) -
            mean(temporary$Movement_Type[temporary$Trial_Type == "1"])
