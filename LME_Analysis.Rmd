...
for (i in 1:length(Pltx_SPB_CONTROL_1)){
  Pltx_SPB_CONTROL_1[i] = jitter(Pltx_SPB_CONTROL_1[i],factor = 6)
}
...
for (i in 1:length(Pltx_SPB_CONTROL_2)){
  Pltx_SPB_CONTROL_2[i] = jitter(Pltx_SPB_CONTROL_2[i],factor = 6)
}
...
#main = "Average BvH",
ylab = "Bearing-heading difference (Radians)",
at = c(1,2),
names = c("Control", "Spun"),
las = 2,
col = c("#C1FFC1","#FFAEB9"),
...
barplot(as.matrix(SF_ratio),col=c("#E74C3C","#27AE60"))
```
