...
```{r}
WORKD = "C:\\your_information\\Bowers_2025_Octopus_Vestibular"
```

#Vector of trial dates
```{r}
...
#Create a vector of the file names of full video results data
```{r}
...
#Create a vector of the file names of path analysis results data
```{r}
...
#Create a compiled table of all results for each trial/octopus. FULL VID RESULTS
```{r}
Date = c()
OC_ID = c()
Trial_Type = c()
...
#Create a compiled table of all results for each trial/octopus. PATH ANALYSIS RESULTS
```{r}
...
#FINDING MEANS FOR FV AND PA DATA
```{r}
