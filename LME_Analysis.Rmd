...
points(Bearing_Change~NewDates,
     data=PA_master_set[PA_master_set$Movement_Type==1&PA_master_set$Trial_Type==1,],
     pch=21,bg="#eb3a23")
legend("top",c("Spun","Control"),fill = c("#eb3a23","#52c155"), cex = 0.45)
...
points(x = Pltx_BvH_CONTROL_1 ,y = PA_BvH_CONTROL,col="black")
points(x = Pltx_BvH_SPUN_1 ,y = PA_BvH_SPUN,col="black")
...
```
```{r}
PA_BvHC_SPUN = (PA_master_set$Avg_Bearing_vs_Heading_Change[PA_master_set$Movement_Type==1&PA_master_set$Trial_Type==1])
PA_BvHC_CONTROL = (PA_master_set$Avg_Bearing_vs_Heading_Change[PA_master_set$Movement_Type==1&PA_master_set$Trial_Type==4])
...
points(x = Pltx_BvH_CONTROL_FV ,y = FV_BvH_CONTROL,col="black")
points(x = Pltx_BvH_SPUN_FV ,y = FV_BvH_SPUN,col="black")
